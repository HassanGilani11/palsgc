...
$store_open_notice        = isset($store_info['dokan_store_open_notice']) && !empty($store_info['dokan_store_open_notice']) ? $store_info['dokan_store_open_notice'] : __('Store Open', 'printec');
$store_closed_notice      = isset($store_info['dokan_store_close_notice']) && !empty($store_info['dokan_store_close_notice']) ? $store_info['dokan_store_close_notice'] : __('Store Closed', 'printec');
                    ...
                    <div class="profile-info">
                        ...
                        <ul class="dokan-store-info">
                            <?php if (!dokan_is_vendor_info_hidden('address') && isset($store_address) && !empty($store_address)) { ?>
                                <li class="dokan-store-address"><i class="printec-icon-map-marker-alt"></i>
                            ...
                            <?php if ($show_store_open_close == 'on' && $dokan_store_time_enabled == 'yes') : ?>
                                <li class="dokan-store-open-close">
                                    <i class="printec-icon-store-2"></i>
                                    <div class="store-open-close-notice">
                                        ...
                                        <span class="printec-icon-angle-down"></span>
                                        <div id="vendor-store-times">
                                            <div class="store-times-heading">
                                                <i class="fas fa-calendar-day"></i>
                                                <h4><?php esc_html_e('Weekly Store Timing', 'printec'); ?></h4>
                                            </div>
                                            <?php
                                            foreach (dokan_get_translated_days() as $day_key => $day) :
                                                ...
                                                $class_current = $today === $day_key ? 'current_day' : '';
                                                ?>
                                                <div class="store-time-tags">
                                                    <div class="store-days <?php echo esc_attr($class_current); ?>"><?php echo esc_html($day); ?></div>
                                                    <div class="store-times">
                                                        <?php if ($store_status === 'close') : ?>
                                                            <span class="store-close"><?php esc_html_e('CLOSED', 'printec'); ?></span>
                                                        <?php endif; ?>
