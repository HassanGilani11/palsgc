...
if(!function_exists('printec_dokan_sold_store')){
    function printec_dokan_sold_store(){
        global $product;
        ...
        <div class="sold-by-meta">
            <span class="sold-by-label"><?php esc_html_e( 'Sold By:', 'printec' ); ?> </span>
...
if (!function_exists('printec_add_vendor_info_on_product_single_page')) {
    function printec_add_vendor_info_on_product_single_page() {
        global $product;
        $vendor       = dokan_get_vendor_by_product( $product );
        if(!$vendor->id){
            return;
            ...
            <div class="dokan-vendor-info-wrap">
                ...
                <div class="dokan-vendor-info">
                    ...
                    <a class="dokan-button-vendor" href="<?php echo esc_attr( $vendor->get_shop_url() ); ?>">
                        <?php echo esc_html__('View Vendor', 'printec')?>
                    </a>
                </div>
            </div>
            <?php
