<?php
/**
 * Printec_Product_Brand_List_Walker class
 *
 * @extends    Walker
 * @class        Printec_Product_Brand_List_Walker
 * @version        2.3.0
...
if (!class_exists('Printec_Product_Brand_List_Walker', false)) :

	class Printec_Product_Brand_List_Walker extends Walker {
