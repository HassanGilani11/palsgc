<?php
/**
 * Printec WooCommerce Adjacent Products Class
 *
 * @package  printec
 * @since    2.4.3
 */
...
if ( ! class_exists( 'Printec_WooCommerce_Adjacent_Products' ) ) :

	/**
	 * The Printec WooCommerce Adjacent Products Class
	 */
	class Printec_WooCommerce_Adjacent_Products {
		...
		private function query_wc() {
			...
			$products = wc_get_products( apply_filters( 'printec_woocommerce_adjacent_query_args', $args ) );
