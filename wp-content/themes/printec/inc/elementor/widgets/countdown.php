...
class Printec_Elementor_Countdown extends Elementor\Widget_Base
{

    public function get_name()
    {
        return 'printec-countdown';
    }

    public function get_title()
    {
        return esc_html__('printec Countdown', 'printec');
    }
    ...
    {
        return ['printec-elementor-countdown'];
    }
    ...
    protected function register_controls()
    {
        $this->start_controls_section(
            'section_countdown',
            [
                'label' => esc_html__('Countdown', 'printec'),
            ]
        );
        ...
        $this->add_control(
            'due_date',
            [
                'label' => esc_html__('Due Date', 'printec'),
                'type' => Controls_Manager::DATE_TIME,
                'default' => date('Y-m-d H:i', strtotime('+1 month') + (get_option('gmt_offset') * HOUR_IN_SECONDS)),
                /* translators: %s: Time zone. */
                'description' => sprintf(esc_html__('Date set according to your timezone: %s.', 'printec'), Utils::get_timezone_string()),
            ]
        );
        ...
        $this->add_control(
            'show_hours',
            [
                'label' => esc_html__('Hours', 'printec'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'printec'),
                'label_off' => esc_html__('Hide', 'printec'),
                'default' => 'yes',
        ...
        $this->add_control(
            'show_minutes',
            [
                'label' => esc_html__('Minutes', 'printec'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'printec'),
                'label_off' => esc_html__('Hide', 'printec'),
                'default' => 'yes',
        ...
        $this->add_control(
            'show_seconds',
            [
                'label' => esc_html__('Seconds', 'printec'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'printec'),
                'label_off' => esc_html__('Hide', 'printec'),
                'default' => 'yes',
        ...
        $this->add_control(
            'show_labels',
            [
                'label' => esc_html__('Show Label', 'printec'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Show', 'printec'),
                'label_off' => esc_html__('Hide', 'printec'),
                'default' => 'yes',
        ...
        $this->add_control(
            'custom_labels',
            [
                'label' => esc_html__('Custom Label', 'printec'),
                'type' => Controls_Manager::SWITCHER,
                'condition' => [
                    'show_labels!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Days', 'printec'),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('Days', 'printec'),
                'placeholder' => esc_html__('Days', 'printec'),
                'condition' => [
                    'show_labels!' => '',
                    'custom_labels!' => '',
                    'show_days' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Hours', 'printec'),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('Hours', 'printec'),
                'placeholder' => esc_html__('Hours', 'printec'),
                'condition' => [
                    'show_labels!' => '',
                    'custom_labels!' => '',
                    'show_hours' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Minutes', 'printec'),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('Minutes', 'printec'),
                'placeholder' => esc_html__('Minutes', 'printec'),
                'condition' => [
                    'show_labels!' => '',
                    'custom_labels!' => '',
                    'show_minutes' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Seconds', 'printec'),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('Seconds', 'printec'),
                'placeholder' => esc_html__('Seconds', 'printec'),
                'condition' => [
                    'show_labels!' => '',
                    'custom_labels!' => '',
                    'show_seconds' => 'yes',
        ...
        $this->start_controls_section(
            'section_box_style',
            [
                'label' => esc_html__('Boxes', 'printec'),
        ...
        $this->add_responsive_control(
            'container_width',
            [
                'label' => esc_html__('Container Width', 'printec'),
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
                    '{{WRAPPER}} .elementor-printec-countdown' => 'max-width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'items_width',
            [
                'label' => esc_html__('Items Width', 'printec'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_responsive_control(
            'items_height',
            [
                'label' => esc_html__('Items Height', 'printec'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}}.elementor-widget-printec-countdown .elementor-countdown-item:before' => 'right: -{{RIGHT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => 'center',
                'selectors' => [
                    '{{WRAPPER}} .elementor-printec-countdown' => 'justify-content: {{VALUE}}',
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Digits', 'printec'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->start_controls_section(
            'section_label_style',
            [
                'label' => esc_html__('Label', 'printec'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
    ...
    private function _init_default_countdown_labels()
    {
        $this->_default_countdown_labels = [
            'label_months' => esc_html__('Months', 'printec'),
            'label_weeks' => esc_html__('Weeks', 'printec'),
            'label_days' => esc_html__('Days', 'printec'),
            'label_hours' => esc_html__('Hrs', 'printec'),
            'label_minutes' => esc_html__('Mins', 'printec'),
            'label_seconds' => esc_html__('Secs', 'printec'),
        ];
    }
    ...
    protected function render()
    {
        ...
        <div class="countdown-inner">
            ...
            <?php endif; ?>
            <div class="elementor-printec-countdown" data-date="<?php echo esc_attr($due_date); ?>">
                <?php echo printec_elementor_get_strftime($instance, $this); // WPCS: XSS ok. ?>
            </div>
        </div>
        <?php
    }
...
$widgets_manager->register(new Printec_Elementor_Countdown());
