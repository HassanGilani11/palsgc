	...
	<td style="padding: 5px 0;">
		...
		<?php if (( 'quote-approved' !== $order->get_status() && true !== $is_hide_price_enabled ) || ( 'quote-approved' === $order->get_status() )) { ?>
			<tr>
				...
				<td style="width: 100px;">
					<?php echo ( 0 !== $order->get_subtotal() && '' !== $order->get_subtotal() && '0' !== $order->get_subtotal() ) ? esc_html( number_format( $order->get_subtotal() , 2) . ' ' . get_woocommerce_currency() ) : 0; ?>
				</td>
			</tr>
			<tr>
				<td style="width: 100px;">
				...
				<td style="width: 100px;">
					<?php echo esc_html(!empty($order->get_total_fees()) ? number_format( $order->get_total_fees() , 2 ) . ' ' . get_woocommerce_currency() : '-'); ?>
				</td>
			</tr>
			<tr>
				<td style="width: 100px;">
				...
				<td style="width: 100px;">
					<?php echo esc_html(!empty($order->get_discount_total()) ?  number_format($order->get_discount_total() , 2) . ' ' . get_woocommerce_currency() : '-'); ?>
				</td>
			</tr>
			<tr>
				<td style="width: 100px;">
				...
				<td style="width: 100px;">
					<?php echo esc_html(!empty($order->get_total_tax()) ? number_format( $order->get_total_tax() , 2) . ' ' . get_woocommerce_currency() : '-'); ?>
				</td>
			</tr>
			<tr>
				...
				<td style="width: 100px;color: #10518D;">
					<?php echo ( 0 !== $order->get_total() && '' !== $order->get_total() && '0' !== $order->get_total() ) ? esc_html( number_format( $order->get_total() , 2) . ' ' . get_woocommerce_currency() ) : 0; ?>
				</td>
			</tr>
			<?php } ?>
		</table>
