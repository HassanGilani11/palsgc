...
class QuoteListController {
	...
	public static function init() {
		...
		if (!empty($theme)) {
			if ( 'Twenty Twenty-Three' === $theme->name || 'Twenty Twenty-Four' === $theme->name || 'Twenty Twenty-Two' === $theme->name) {
		...
		if ( ( ( in_array( 'elementor/elementor.php', $activated_plugins ) || array_key_exists( 'elementor/elementor.php', $activated_plugins ) ) ) && ( 'Twenty Twenty-Three' === $theme->name || 'Twenty Twenty-Four' === $theme->name || 'Twenty Twenty-Two' === $theme->name )) {
