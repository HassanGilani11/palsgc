                    ...
                    <div className="row align-items-center mb-3">
                        <div className="col-lg-4 col-md-6">
                            <div className="d-flex justify-content-between align-items-center">
                                ...
                                <div type="button" class="" data-bs-toggle="tooltip" data-bs-placement="top" title={__("Enter the text you want to display as the header/title of the quote form." , 'elex-request-a-quote' )} >
                    ...
                    <div className="row align-items-center mb-3">
                        <div className="col-lg-4 col-md-6">
                            <div className="d-flex justify-content-between align-items-center">
                                ...
                                title={__("Please provide the page URL that you wish to redirect to, After clicking the 'Send Request' button" , 'elex-request-a-quote' )}
                                >
                    ...
                    <div className="row align-items-center mb-3">
                        <div className="col-lg-4 col-md-6">
                            <div className="d-flex justify-content-between align-items-center">
                                ...
                                <div type="button" class="" data-bs-toggle="tooltip" data-bs-placement="top" 
                                 title={__("Enter the text that you want to display as a message after the successful submission of the quote request." , 'elex-request-a-quote' )}
                                >
                                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26">
                                    <g id="tt" transform="translate(-384 -226)">
                                        <g id="Ellipse_1" data-name="Ellipse 1"
