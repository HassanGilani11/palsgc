								...
								<div
									...
									<div class="d-flex justify-content-center align-items-center w-100 h-100">
										<div class="position-relative overflow-auto h-100  "
											...
											<?php
									ob_start();
									require ELEX_RAQ_SRC_PATH . 'TemplateSetting/DefaultTemplates/squared_logo_template.php';
								...
								<div
									...
									<div class="d-flex justify-content-center align-items-center w-100 h-100">
										<div class="position-relative overflow-auto h-100  "
											...
											<?php
												ob_start();
												require ELEX_RAQ_SRC_PATH . 'TemplateSetting/DefaultTemplates/rectangle_logo_template.php';
												$content = ob_get_clean();
												echo wp_kses_post( $content );
											?>
								...
								<div
									...
									<div class="d-flex justify-content-center align-items-center w-100 h-100">
										<div class="position-relative overflow-auto h-100  "
											...
											<?php
									ob_start();
									require ELEX_RAQ_SRC_PATH . 'TemplateSetting/DefaultTemplates/non_logo_template.php';
									$content = ob_get_clean();
									echo wp_kses_post( $content );
											?>
						...
						<table class="table mb-2">
							...
							<tbody class="border-top-0">
								...
								<tr>
									...
									<td><?php esc_html_e( '@order_id', 'elex-request-a-quote' ); ?></td>
								</tr>
								<tr>
