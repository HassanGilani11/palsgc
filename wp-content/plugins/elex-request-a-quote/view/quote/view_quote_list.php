<div class="elex-rqst-quote-front-wrap" style="width:100%">
	<div class="w-100 <?php ( is_shop() && ( 'Twenty Twenty-Three' === $product_data['theme'] ) || ( 'Twenty Twenty-Four' === $product_data['theme'] ) || ( 'Twenty Twenty-Two' === $product_data['theme'] ) ) ?  esc_html_e('text-center'): ''; ?>">
